...
def Parse_event(mvtx_cluster_types, filename, output_dir, file_number):
    ...
    for event in raw_data['Events']:
        ...
        trigger = -1
        ip = np.array([np.nan, np.nan, np.nan])
        ...
        if n_MVTXHits == 0 and n_INTTHits == 0:
            empty_event += 1
...
def main():
    ...
    """Main function"""
    TRIGGER_DATA_DIR = '/home1/zhaozhongshi/Run2024PPData/'
    TRIGGER_DATA_DIR = '/disks/disk1/zhaozhong/ppRealData'
    trigger_output_dir = '/ssd3/giorgian/hits-data-september-2024-pprealdata'
